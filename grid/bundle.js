...
var taps = downs.flatMap(function (down) {
    ...
    return ups.take(1).takeUntil(timer).filter(function (up) {
        return distance(down, up) < 10;
    });
});

taps.subscribe(function (tap) {
    console.log("tap @ (" + tap + ")");
    gridView.getCellAtLocation.apply(gridView, _toConsumableArray(tap));
});
...
},{"./canvas_extensions":"/Users/kevin/seed/grid/canvas_extensions.js","./grid":"/Users/kevin/seed/grid/grid.js","rx":"/Users/kevin/seed/node_modules/rx/dist/rx.all.js"}],"/Users/kevin/seed/grid/canvas_extensions.js":[function(require,module,exports){
"use strict";
...
},{}],"/Users/kevin/seed/node_modules/rx/dist/rx.all.js":[function(require,module,exports){
